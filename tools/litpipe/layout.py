...
# ---------- 子类划分 ----------
COL2SUB = {
 # 2026-07 越野模块化重组后的新叶名 → 自驾页的 5 条子泳道。
 # 新体系 15 个叶比页面泳道细,这里做收敛映射;不映射就会掉进标题关键词猜测。
 "2.1.1.1 越野语义分割与地形类别识别":"感知可通行",
 "2.1.1.2 域偏移·开放词表与基础模型地形理解":"感知可通行",
 "2.1.3.1 点云地面分割与几何原语提取":"感知可通行",
 "2.1.4.1 几何规则·仿真与标注监督的可通行代价图":"感知可通行",
 "2.1.4.2 本体感觉·振动声学·牵引力监督":"感知可通行",
 "2.1.4.3 视觉足迹伪标签与安全地形自监督":"感知可通行",
 "2.1.4.4 野外在线自适应与免标注可通行性":"感知可通行",
 "2.1.5 可通行性概率化·风险与可达速度分布":"感知可通行",
 "2.1.2 多模态融合与传感前端":"融合",
 "2.1.3.2 高程图与概率地形建图":"融合",
 "2.1.3.3 BEV 语义-几何联合建图与三维占用":"融合",
 "2.1.6.1 越野路径规划与示教代价学习":"导航规划",
 "2.1.6.2 地形动力学建模与高速控制":"导航规划",
 "2.1.6.3 足式与异构平台地形通过":"导航规划",
 "2.1.7 综述与评测基准":"其他",
 # —— 旧叶名保留,老数据/未迁条目仍能命中 ——
